...
class MyunetUp(nn.Module):
  ...
  def forward(self, raw_data, shrunk_data):
    restored_data = self.up(shrunk_data)

    # return restored_data + raw_data
    # return restored_data
    return self.conv(torch.cat([raw_data, restored_data], 1))
